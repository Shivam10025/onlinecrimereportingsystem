...
class Complaintable extends StatefulWidget {
  //const Complaintable({Key? key}) : super(key: key);

  @override
  _ComplaintableState createState() => _ComplaintableState();
}

class _ComplaintableState extends State<Complaintable> {
  late EmployeeDataSource employeeDataSource;
  late List<GridColumn> _columns;
  Future<dynamic> generateEmployeeList() async {
    // Give your sever URL of get_employees_details.php file
    var url = Uri.parse('https://ocmr.000webhostapp.com/complaintable.php');
                ...
                Padding(
                  ...
                  child: Center(
                      child: Row(
                        ...
                        children: [
                          Icon(CupertinoIcons.book_solid, color: Colors.red,),
                          Text("Complaints Table" , style: GoogleFonts.sora(color: Colors.blue.withGreen(100), fontSize: 25 , fontWeight: FontWeight.bold))
                        ],
                      )
                        ),
                ),
