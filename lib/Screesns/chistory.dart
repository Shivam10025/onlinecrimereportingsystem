...
class HistoryPortal extends StatefulWidget {
  late String email;
  HistoryPortal(this.email);
  //const HistoryPortal({Key? key}) : super(key: key);
  @override
  _HistoryPortalState createState() => _HistoryPortalState();
}

class _HistoryPortalState extends State<HistoryPortal> {
  late EmployeeDataSource employeeDataSource;
  late List<GridColumn> _columns;
  Future<dynamic> generateEmployeeList() async {
    // Give your sever URL of get_employees_details.php file
    var url = Uri.parse('https://ocmr.000webhostapp.com/complain.php');
                ...
                Padding(
                  ...
                  child: Center(
                    ...
                    mainAxisAlignment: MainAxisAlignment.center,
                        children: [
                          Icon(CupertinoIcons.mail_solid, color: Colors.red,),
                          Text("Complaints History" , style: GoogleFonts.sora(color: Colors.blue.withGreen(100), fontSize: 25 , fontWeight: FontWeight.bold))
                        ],
                      )
                  ),
                ),
