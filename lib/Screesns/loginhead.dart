...
class LoginHeadScreen extends StatefulWidget {
 // const LoginHeadScreen({Key? key}) : super(key: key);

  @override
  _LoginHeadScreenState createState() => _LoginHeadScreenState();
}

class _LoginHeadScreenState extends State<LoginHeadScreen> {
  bool invisible = true;
  bool visible = false ;
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: Center(
                              child: Container(
                                width: 200,
                                height: 200,
                                child: Image.network('https://cdn.dribbble.com/users/1018473/screenshots/5344535/login.png' ,),
                                decoration: BoxDecoration(
                          ...
                          Padding(
                            ...
                            child: Center(
                                child: Text("Login as Police Commissioner" , style: GoogleFonts.sora(color: Colors.deepPurple , fontSize: 22 , fontWeight: FontWeight.bold))
                            ),
                          ),
                          Padding(
                          ...
                          Padding(
                            padding: const EdgeInsets.only(left: 15.0 , right: 15.0 , top: 18.0 , bottom: 15.0),
                            child: Center(
                              child: Container(
                                height: 50,
                                width: 250,
                                ...
                                child: FlatButton(
                                  onPressed: () {
                                    ...
                                    else if(mail.text.toLowerCase() == 'bt19cse008@gmail.com' && password.text == '1234567'){
                                      Navigator.push(context, MaterialPageRoute(builder: (_) => HeaduarterScreen()));
                                    }
                                    else {
